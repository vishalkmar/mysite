    ...
    >
      <div className="container py-5">
        ...
        <div className="row align-items-center g-4 mb-5">
          {/* LEFT: CIRCLE IMAGE (ab left side) */}
          ...
          <div className="col-lg-6">
            ...
            >
              About NexaTechInnovation · Software · Digital · Experience
            </h2>

            <p className="text-white mb-4" style={{ fontSize: "0.98rem" }}>
              NexaTechInnovation is a future-ready software startup focused on
              building smart, scalable and user-centric digital products. We
              craft web applications, mobile apps, custom software and digital
              experiences that help brands grow faster and operate smarter.
            </p>
          ...
          <div className="col-12 col-md-6 col-lg-3">
            ...
            >
              <div className="card-body d-flex flex-column align-items-center text-center p-4">
                ...
                >
                  To deliver innovative software solutions that transform
            ...
            >
              <div className="card-body d-flex flex-column align-items-center text-center p-4">
                ...
                <p
                  ...
                  style={{ color: "rgba(226, 232, 240, 0.9)" }}
                >
                  A talented group of developers, designers and strategists
            ...
            >
              <div className="card-body d-flex flex-column align-items-center text-center p-4">
                ...
                <p
                  ...
                  style={{ color: "rgba(226, 232, 240, 0.9)" }}
                >
                  Recognized as top developers with 50+ successful projects and
                  a 98% client satisfaction rate across global industries.
                </p>
              </div>
            </div>
          </div>
