...
const ParagraphText2 = forwardRef((props, ref) => {
  const {
    label,
  ...
  return (
    <>
      {/* ✅ merged CSS (Roboto removed) */}
      <style>{`
        .paragraph-text2 {
          display: inline;
        }

        .paragraph-text2 .sr-only {
          position: absolute;
          width: 1px;
          height: 1px;
          padding: 0;
      ...
      <span
        ref={ref}
        className={`paragraph-text2 ${className}`}
        onClick={onClick}
